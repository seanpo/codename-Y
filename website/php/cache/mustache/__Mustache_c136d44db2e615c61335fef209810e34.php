...
class __Mustache_c136d44db2e615c61335fef209810e34 extends Mustache_Template
{
...
';
        // 'users' section
        $buffer .= $this->section205e64198c135c653e797b2d2ec2a0d4($context, $indent, $context->find('users'));
        $buffer .= $indent . '</div>
';
...
';
    ...
    private function section205e64198c135c653e797b2d2ec2a0d4(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
