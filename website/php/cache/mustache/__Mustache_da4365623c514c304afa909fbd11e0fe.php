...
class __Mustache_da4365623c514c304afa909fbd11e0fe extends Mustache_Template
{
...
';
        // 'users' section
        $buffer .= $this->sectionC3ac6fe7fa2e2da7925b247029235ea0($context, $indent, $context->find('users'));
        $buffer .= $indent . '</div>
';
...
';
    ...
    private function sectionC3ac6fe7fa2e2da7925b247029235ea0(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    <div id="{{id}}" class="user pointerCursor" location="{{location}}" image="{{image}}">
      ...
      <div class="email pointerCursor">
        <p><a href="https://mail.google.com/mail/?view=cm&fs=1&to={{email}}&tf=1">{{email}}</a></p>
      </div>
    </div> 
  ';
...
';
                $buffer .= $indent . '        <p><a href="https://mail.google.com/mail/?view=cm&fs=1&to=';
