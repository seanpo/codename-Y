...
class __Mustache_e88897785d092c985a3d576fd2b3bf32 extends Mustache_Template
{
...
';
        // 'users' section
        $buffer .= $this->section961d016d2951883965a21d6b2e54cd3c($context, $indent, $context->find('users'));
        $buffer .= $indent . '</div>
';
...
';
    ...
    private function section961d016d2951883965a21d6b2e54cd3c(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
