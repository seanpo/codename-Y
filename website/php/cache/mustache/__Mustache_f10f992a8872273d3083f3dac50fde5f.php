...
class __Mustache_f10f992a8872273d3083f3dac50fde5f extends Mustache_Template
{
...
';
        // 'users' section
        $buffer .= $this->section6ae86f59abfae5b03c69b1c0b4572b49($context, $indent, $context->find('users'));
        $buffer .= $indent . '</div>
';
...
';
    ...
    private function section6ae86f59abfae5b03c69b1c0b4572b49(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
