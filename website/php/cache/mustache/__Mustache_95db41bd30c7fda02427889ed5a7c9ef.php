...
class __Mustache_95db41bd30c7fda02427889ed5a7c9ef extends Mustache_Template
{
...
';
        // 'users' section
        $buffer .= $this->section3ab7477126d0a028b758542f2bd40f5b($context, $indent, $context->find('users'));
        $buffer .= $indent . '</div>
';
...
';
    ...
    private function section3ab7477126d0a028b758542f2bd40f5b(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
