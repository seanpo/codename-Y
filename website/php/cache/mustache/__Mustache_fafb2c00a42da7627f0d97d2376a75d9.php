...
class __Mustache_fafb2c00a42da7627f0d97d2376a75d9 extends Mustache_Template
{
...
';
        // 'users' section
        $buffer .= $this->sectionEb4e8e7f470ce03448bdd9928bbe788b($context, $indent, $context->find('users'));
        $buffer .= $indent . '</div>
';
...
';
    ...
    private function sectionEb4e8e7f470ce03448bdd9928bbe788b(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
