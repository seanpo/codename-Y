...
class __Mustache_bba0e6906a1b6eb2bc2a7cf668eb21c6 extends Mustache_Template
{
...
';
        // 'users' section
        $buffer .= $this->section7b88efe0191a3a135596dd40223fb419($context, $indent, $context->find('users'));
        $buffer .= $indent . '</div>
';
...
';
    ...
    private function section7b88efe0191a3a135596dd40223fb419(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
