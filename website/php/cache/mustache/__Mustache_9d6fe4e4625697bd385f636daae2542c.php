...
class __Mustache_9d6fe4e4625697bd385f636daae2542c extends Mustache_Template
{
...
';
        // 'users' section
        $buffer .= $this->section069c08d31adb5720951f6a065d842e72($context, $indent, $context->find('users'));
        $buffer .= $indent . '</div>
';
...
';
    ...
    private function section069c08d31adb5720951f6a065d842e72(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
