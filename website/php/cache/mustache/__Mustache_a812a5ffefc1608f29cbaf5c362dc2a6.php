...
class __Mustache_a812a5ffefc1608f29cbaf5c362dc2a6 extends Mustache_Template
{
...
';
        // 'users' section
        $buffer .= $this->section611dd3e97147f324b91b7ddd8dbef248($context, $indent, $context->find('users'));
        $buffer .= $indent . '</div>
';
...
';
    ...
    private function section611dd3e97147f324b91b7ddd8dbef248(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
