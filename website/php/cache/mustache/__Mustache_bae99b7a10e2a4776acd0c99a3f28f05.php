...
class __Mustache_bae99b7a10e2a4776acd0c99a3f28f05 extends Mustache_Template
{
...
';
        // 'users' section
        $buffer .= $this->sectionAc49cdca70f0d083c4c1ea87240934d1($context, $indent, $context->find('users'));
        $buffer .= $indent . '</div>
';
...
';
    ...
    private function sectionAc49cdca70f0d083c4c1ea87240934d1(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
