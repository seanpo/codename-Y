...
class __Mustache_dcdccd878a6bf27c584bba5c57be458a extends Mustache_Template
{
...
';
        // 'users' section
        $buffer .= $this->section3c4a386f667d4cce105552b3686e2d81($context, $indent, $context->find('users'));
        $buffer .= $indent . '</div>
';
...
';
    ...
    private function section3c4a386f667d4cce105552b3686e2d81(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
