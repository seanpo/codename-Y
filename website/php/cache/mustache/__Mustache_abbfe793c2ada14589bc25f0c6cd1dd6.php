...
class __Mustache_abbfe793c2ada14589bc25f0c6cd1dd6 extends Mustache_Template
{
...
';
        // 'users' section
        $buffer .= $this->sectionCf733fe5a9b2083809469f3fbfb16643($context, $indent, $context->find('users'));
        $buffer .= $indent . '</div>
';
...
';
    ...
    private function sectionCf733fe5a9b2083809469f3fbfb16643(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
