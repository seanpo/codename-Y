...
class __Mustache_1bbc336ba9f50f969c322341c07bfa55 extends Mustache_Template
{
...
';
        $buffer .= $indent . '<textarea id="description" type="text" default="A Little Description..."/>
';
