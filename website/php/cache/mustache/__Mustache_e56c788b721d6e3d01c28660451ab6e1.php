...
class __Mustache_e56c788b721d6e3d01c28660451ab6e1 extends Mustache_Template
{
...
';
        // 'users' section
        $buffer .= $this->section4dcde75bd7b0b417b3b66ebcb6049ffd($context, $indent, $context->find('users'));
        $buffer .= $indent . '</div>
';
...
';
    ...
    private function section0943f29b1bdf95846ac2251457eb5fdf(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
          <div class=\'description\'><p>About: {{description}}</p></div>
        ';
            $buffer .= $this->mustache
                ->loadLambda((string) call_user_func($value, $source, $this->lambdaHelper))
                ->renderInternal($context);
            ...
            foreach ($values as $value) {
                $context->push($value);
                $buffer .= $indent . '          <div class=\'description\'><p>About: ';
...
';
    ...
    private function section4dcde75bd7b0b417b3b66ebcb6049ffd(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
...
';
                ...
                // 'description' section
                $buffer .= $this->section0943f29b1bdf95846ac2251457eb5fdf($context, $indent, $context->find('description'));
                $buffer .= $indent . '      </div>
';
                $buffer .= $indent . '    </div>
';
